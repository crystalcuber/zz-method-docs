...
We currently have 235 solves from five ZZ solvers. Check them out!

<Cards>
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
    title="Yoruba's Official 6.26 ao5"
    href="/example-solves/yoruba-6.26-ao5"
  />
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
  ...
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
    title="Luna's 7.12 ao12"
    href="/example-solves/luna-7.12-ao12"
  />
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
  ...
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
    title="Luna's 7.78 ao50"
    href="/example-solves/luna-7.78-ao50"
  />
  <Cards.Card
    icon={<Image src={logoEOCross} width={55} />}
